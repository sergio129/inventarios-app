...
export function InventoryContent() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-blue-600/5 to-purple-600/5 -z-10" />
      ...
      <div className="container mx-auto px-6 py-8 relative">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-linear-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg">
                ...
                <Dialog open={isProductDialogOpen} onOpenChange={setIsProductDialogOpen}>
                  <DialogTrigger asChild>
                    <Button
                      ...
                      className="flex items-center gap-1 md:gap-2 text-xs md:text-sm px-2 md:px-3 py-1 md:py-2 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
                    >
                      <Plus className="h-3 md:h-4 w-3 md:w-4" />
                      <span>Nuevo Producto</span>
                    </Button>
                  </DialogTrigger>
              <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto bg-linear-to-br from-white to-gray-50 border-0 shadow-2xl">
                <DialogHeader className="pb-6 border-b border-gray-200 bg-linear-to-r from-blue-50 to-indigo-50 -m-6 mb-6 p-6 rounded-t-lg">
                ...
                <DialogFooter className="border-t border-gray-200 pt-6 bg-gray-50 -m-6 mt-6 p-6 rounded-b-lg">
                  <div className="flex justify-between w-full">
                    ...
                    <Button
                      ...
                      className="bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-2 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
                    >
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-2xl shadow-blue-500/10">
          <CardHeader className="bg-linear-to-r from-blue-50/50 to-purple-50/50 border-b border-gray-100/50">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-linear-to-r from-blue-500 to-purple-500 rounded-lg shadow-lg">
                ...
                <TableBody>
                  {paginatedProducts.map((product: Product) => {
                    ...
                    return (
                      <TableRow
                        key={product._id}
                        className="border-b border-gray-100/50 hover:bg-linear-to-r hover:from-blue-50/30 hover:to-purple-50/30 transition-all duration-200 group text-xs md:text-sm"
                      >
                        ...
                        <TableCell className="py-3 md:py-4 px-3 md:px-6 hidden md:table-cell">
                          <Badge
                            variant="outline"
                            className="bg-linear-to-r from-blue-50 to-purple-50 border-blue-200 text-blue-700 font-medium shadow-sm text-xs"
                          >
                            {product.categoria}
                          </Badge>
                        </TableCell>
